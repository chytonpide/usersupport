 ...
 */
public class SupportCaseProducerAdapter implements ExchangeAdapter<IdentifiedDomainEvent, IdentifiedDomainEvent, Message> {

  private static final String SCHEMA_PREFIX = "nconnect:usersupport:com.nconnect.usersupport";
